...
const QA_ITEMS: QAItem[] = [
  {
    ...
    category: 'ログイン・アカウント',
    title: 'ログインの基本手順',
    summary: 'ログイン画面で発行されたIDとパスワードを入力して利用を開始します。',
    keywords: ['ログイン', 'サインイン', 'ID', 'ユーザーID', 'パスワード'],
    steps: ['ログイン画面を開きます。', '管理者から発行されたIDとパスワードを入力します。', 'ログイン後、上部メニューから各ページへ移動できます。'],
    contactHint: 'IDやパスワードはユーザー自身で変更・再発行できないため、管理者へ連絡してください。',
    badge: 'まず確認',
  },
  {
    id: 'guide-stamp',
  ...
  },
  {
    ...
    keywords: ['ログインできない', '入れない', 'ID', 'ユーザーID', 'パスワード', '認証'],
    symptom: '「ログインに失敗する」「画面が戻る」',
    cause: '発行されたID・パスワードの入力違い、または古い入力情報が残っている可能性があります。',
    checkFirst: ['発行されたIDの入力ミスがないか', '大文字・小文字、全角半角の違いがないか'],
    steps: ['IDとパスワードを入力し直して再度ログインします。', 'ブラウザを再読み込みします。', '改善しない場合は管理者にID・パスワードの再発行を依頼します。'],
  ...
  },
  {
    ...
    checkFirst: ['iPhone: 設定 → プライバシーとセキュリティ → 位置情報サービスがONか', 'Android: 設定 → 位置情報がONか', 'ブラウザでこのサイトの位置情報を許可しているか'],
    steps: ['iPhone: Safariのサイト設定で位置情報を「許可」にして再読み込みします。', 'Android: Chromeのサイト設定で位置情報を「許可」にして再読み込みします。', '屋内で電波が弱い場合は窓際などで再試行し、改善しない場合は管理者に相談します。'],
